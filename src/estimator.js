...
const challengeTwoFunction = (severeImpactInfectionsByRequestedTime, impactInfectionsByRequestedTime, totalHospitalBeds) => {
  ...
  challengeTwoData.impactHospitalBedsByRequestedTime = Math.trunc(Math.trunc(totalHospitalBeds * 0.30) - challengeTwoData.impactSevereCasesByRequestedTime);
  challengeTwoData.severeImpactHospitalBedsByRequestedTime = Math.trunc(Math.trunc(totalHospitalBeds * 0.25) - challengeTwoData.severeImpactSevereCasesByRequestedTime);
